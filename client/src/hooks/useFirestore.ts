...
export const useFirestoreDocument = (refpath: any, options: any = null) => {
...
export const useFirestoreDocumentOnce = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
...
export const useFirestoreDocumentData = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
...
export const useFirestoreDocumentDataOnce = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
...
export const useFirestoreCollection = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
...
export const useFirestoreCollectionOnce = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
...
export const useFirestoreCollectionData = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
...
export const useFirestoreCollectionDataOnce = (refpath: any, options: any = null) => {
  const {firebase} = useSession();
  let ref;
  if (typeof refpath === 'string') {
    refpath = getPath(refpath);
