    ...
    <div className={classes.root}>
      ...
      >
        ...
        > 
          ...
          <Button className={classes.button} variant="contained" color="primary" onClick={() => {const id: any = prompt('Welk Id wil je aanpassen?');const value=prompt('Nieuwe waarde?');request.put(parseInt(id), {value})}}>Put data</Button>
          <Button className={classes.button} variant="contained" color="primary" onClick={() => {const id: any = prompt('Welk Id wil je verwijderen?');request.destroy(parseInt(id))}}>Delete data</Button>
        </Grid>
      </Grid>
      <Table 
        columns={columns}
